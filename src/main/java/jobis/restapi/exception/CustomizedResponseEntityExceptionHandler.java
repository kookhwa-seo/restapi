...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({UserNotFoundException.class, ScrapNotFoundException.class})
    ...
    @ExceptionHandler({UserExistException.class, PersonalInfoNotFoundException.class})
